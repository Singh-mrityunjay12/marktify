                        ...
                        <div class="tp_product_detail">
                            <ul>
                                @if (!empty($product->published_at))
                                    <li> Last Update <span>{{ set_date_format2(@$product->last_modified) }}</span></li>
                                    <li> Published <span>{{ set_date_format2(@$product->published_at) }}</span></li>
                                @endif
                                ...
                                <li> Tags <span class="ms-3">{{ @$product->tags }}</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="tp_leftbar_box">
                                    ...
                                    <div class="star_rating">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                {{ @$product->getUser->getProductSales() }} Sales
                                            </li>
                                        </ul>
                                    </div>
                                </div>
