                            ...
                            <div class="tp_istop_box">
                                    ...
                                    <a href="javascript:;">
                                        <div class="grid_img">
                                            ...
                                            <span class="tp-product-list-img tp-animation">
                                                {{-- <img src="{{ asset('user-theme/assets/images/videoImage.png') }}"class="tp-animation-img" alt="Image" /> --}}
                                                {{-- <video width="100%" height="100%" controls>
                                                    <source src="{{ Storage::url($items->image) }}" class="tp-animation-img"
                                                        alt="project-img">
                                                </video> --}}
                                                <video width="100%" height="100%" controls>
                                ...
                                <div class="tp_isbox_content">
                                    ...
                                    <div class="addto_cart">
                                        <h4>
                                            <span>{{ $price_symbol }}{{ $item->price }}</span>
                                        </h4>
                                    </div>
                                </div>
