        ...
        <div class="tp_tab_wrappo">
            ...
            @if (isset($data->id) && !@empty($data->id))
                <div class="tp_form_wrapper ">
                    <ul>
                        <li class="active"><a href="{{ route('admin.product.edit', ['id' => $data->id]) }}">Edit (Step 1)</a>
                        </li>
                        <li><a href="{{ route('admin.product.edit.step2', ['id' => $data->id]) }}">Edit (Step 2)</a></li>
                    </ul>
                </div>
            @endif
        </div>
                        ...
                        <div class="tp_catset_box tp_pro_step1">
                            ...
                            <form action="{{ route('admin.product.store.step1') }}" id="product-first-step-form"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="tp_form_wrapper">
                                            <label class="mb-2">Is Feauted</label>
                                            <div class="checkbox">
