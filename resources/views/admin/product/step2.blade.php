                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="tp_catset_box_wrapper">
                        <div class="tp_catset_box">
                            ...
                            {{-- id="product-sec-step-form" --}}


                            <form action="{{ route('admin.product.store.step2') }}" 
                                method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="tp_form_wrapper">
                                                                ...
                                                                <label class="mb-2">File Upload
                                                                    <div class="tp_tooltip tp-tooltip_file"> <i
                                                                        ...
                                                                        <span class="tp_tooltiptext tp_inputnote">
                                                                            <p>In case you don't possess an external file URL, please upload the file.</p>
                                                                        </span>
                                                                    </div>
                                                                </label>
                                    ...
                                    <div class="card d-none" id="bundle-card">
                                        ...
                                        <div class="card-footer">
                                            <button type="button" id="add_new_file" class="tp_btn float-end">Add
                                                New
                                                File</button>
                                        </div>
                                    </div>
