                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <form id="thumbnail-form" action="{{ route('admin.setting.post-media') }}" method="POST"
                        ...
                        <div class="tp_catset_box">
                            <div class="row">
                                <label class="mb-2">Thumbnail Image</label>
                                <div class="col-lg-4 col-md-12">
                                    <div class="tp_form_wrapper">
                                        <label class="mb-2">Allowed File Extensions
                                            <div
                                ...
                                <div class="col-lg-4 col-md-12" id="thumbnail_image">
                                    <div class="tp_form_wrapper">
                                        ...
                                        <input type="number" class="form-control" name="thumb_img_size" id="thumb_img_size"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="tp_form_wrapper">
                                        ...
                                        <input type="number" class="form-control" name="prev_max_file_upload_size"
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="tp_form_wrapper">
                                        <label class="mb-2">Max Upload Files
                                             <div
                                                class="tp_tooltip tp-tooltip_file tp_tooltip_media_file tp_tooltip_media_file">
                                                <i class="fa fa-info-circle" aria-hidden="true"></i>
                                                <span class="tp_tooltiptext tp_inputnote">
                                                    <p>Max Files Allowed.</p>
                                                </span><sup>*</sup>
                                            </div>
                                        </label>
                                        <input type="number" class="form-control" name="prev_max_files" id="prev_max_files"
