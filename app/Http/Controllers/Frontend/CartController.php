...
class CartController extends Controller
{
    ...
    public function store(request $request) {
        ...
        // Cart::instance('default')->add(10,'book',100,5,500,['size'=>'large']);
        ...
        Cart::instance('default')->add($product->id, $productName, 1, $productPrice,100, ['variants' => $variants])->associate('App\Models\Frontend\Product');
